      ...
      <section className="block ab-story">
        <div className="wrap ab-narrow">
          ...
          <p>
            ...
            파고들었습니다. 그렇게 <b>2019년 IPF 코리아 파워리프팅 대회에서 1등</b>을
            했어요. 3대 운동 합계가 540kg까지 올라갔습니다. 드디어 약골 인생을
            청산했다고 생각했죠. 그런데 웃긴 일이 벌어졌어요.{" "}
            <b>대회에서 1등을 한 그 시기에, 계단 5층만 올라가도 헉헉거렸거든요.</b>
          </p>
          <p>
      ...
      <section className="block prod-bg">
        <div className="wrap ab-narrow">
          ...
          <p>
            ...
            하나예요. <b>핵심 동작 몇 가지를 하루 10분씩 꾸준히 한 것.</b>
          </p>
          <p>
