...
export const metadata = {
  ...
  description:
    "운동 20년 중 10년을 날렸습니다. 3대 합계 540kg을 드는데 계단 5층에서 숨이 찼어요. 현대중공업 직장인에서 직장인 체력 전문가가 되기까지.",
...
const PRINCIPLES = [
  ["덜 하자", "주 2~3회만 정확하게 운동하면 됩니다. 많이가 아니라 정확하게입니다."],
  ["자세가 먼저", "무게는 나중입니다. 자세 없는 무게는 부상으로 가는 지름길이에요."],
  [
    "방법이 맞으면 달라진다",
    "당신은 의지가 약한 게 아닙니다. 운동을 지속하는 방법을 몰라서 그런 것뿐이에요.",
  ],
  ["멋진 몸보다 생활 체력", "목표는 과시가 아니라, 퇴근해도 지치지 않는 몸입니다."],
];
  ...
  return (
    <>
      ...
      <div className="sg">
        ...
        <section className="sg-pain">
          ...
          <div>
            ...
            <p className="sg-painend">
              ...
              정상이 아니에요. 분명히 말씀드릴게요.{" "}
              <span className="b">당신의 의지나 나이, 타고난 체질 탓이 아닙니다.</span>{" "}
              하루 8시간 앉아서 일하고, 이동은 차와 엘리베이터로 하고, 몸 쓸 일이
              거의 없는 생활. 이런 구조에서 체력이 멀쩡하면 그게 오히려 이상한
              거거든요.
            </p>
          </div>
        </section>
        ...
        {/* 반전 스토리 (다크) */}
        <section className="sg-narr dark">
          <div className="inner">
            <div className="lab mono">▍저의 이야기</div>
            <h2>저도 똑같았습니다. 아니, 더 심했어요.</h2>

            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img className="sg-id" src="/hyundai-id.jpg" alt="현대중공업 사원증" />
        ...
        {/* 차별점 */}
        <section className="sg-narr">
          <div className="lab mono">▍왜 &lsquo;직장인&rsquo; 체력인가</div>
          <h2>트레이너는 많습니다. 하지만 직장인을 아는 코치는 드뭅니다.</h2>
          <p>
            우리나라 운동 시장은 보디빌딩(몸 만들기)과 다이어트 위주로 돌아갑니다.
            트레이너도 대부분 체대 출신이고요. 입시 때부터 강도 높은 운동을 해온
            분들이라, 솔직히 직장인의 삶을 이해하기는 어렵습니다.
          </p>
          <p>
        ...
        <section className="sg-body">
          <div className="sg-sechead">
            <div className="lab mono">▍백관장의 원칙</div>
            <h2>제가 수강생에게 늘 하는 말</h2>
          </div>
          <div className="sg-cards">
            {PRINCIPLES.map(([t, d]) => (
              <div className="sg-card" key={t}>
                <div className="pn">{t}</div>
                <p>{d}</p>
              </div>
            ))}
          </div>
        ...
        <section className="sg-body tight">
          <div className="sg-sechead">
            <div className="lab mono">▍검증된 길</div>
            <h2>말이 아니라, 결과로 증명합니다</h2>
          </div>
          <div className="sg-bigstats">
            <div>
              <div className="n">6.2만</div>
              <div className="l">유튜브 구독자</div>
            </div>
            <div>
              <div className="n">수백 명</div>
              <div className="l">근력학교 직장인 코칭</div>
            </div>
            <div>
              <div className="n">1등</div>
              <div className="l">2019 IPF 코리아 파워리프팅</div>
            </div>
            <div>
          ...
          <div className="sg-books">
            <b>저서</b> 《최소한의 생존 체력 운동》(교보문고 건강 분야 1위) ·{" "}
        ...
        {/* 변화 */}
        <section className="sg-narr">
          <div className="lab mono">▍실제 변화</div>
          <h2>그들이 한 건 단 하나였습니다</h2>
          <p>
        ...
        <section className="sg-cta">
          <h2>이제 당신 차례입니다</h2>
          <p>
            지금 뭘 사라고 하지 않겠습니다. 먼저 1분이면 끝나는 자가진단으로, 내
            체력이 지금 어느 단계인지부터 확인해보세요.
          </p>
          <div className="btns">
