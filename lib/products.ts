...
export const PRODUCTS: Product[] = [
  {
    ...
    short: "직장인을 위한 케틀벨 체력 솔루션. 가장 빠르고 저렴하게 시작하는 첫걸음 (무료 샘플 제공).",
    via: "리틀리",
    ...
    detail: [
      "사무직 직장인 3년, 체력 코치 8년의 경험을 담아, 케틀벨 하나로 직장인 체력을 키우는 법을 정리한 전자책입니다. 운동 종류를 늘어놓는 책이 아니라, 왜 지치는지·무엇부터 바꿔야 하는지 원리부터 짚습니다.",
      "이미 423건 넘게 판매된, 가장 부담 없이 시작할 수 있는 첫걸음입니다. 구매 전 무료 샘플로 내용을 먼저 확인할 수 있습니다. (디지털 콘텐츠 특성상 다운로드 후 환불은 불가합니다.)",
    ],
  },
  {
    id: "book-survival",
  ...
  },
  {
    ...
    detail: [
      ...
      "정원은 단 6명(소규모), 장소는 근력학교 고대점입니다. 수업 후에는 복습 영상과 전자책이 제공되어 집에서도 혼자 이어갈 수 있습니다. 예약 신청 후 결제 안내 문자를 받고 결제까지 완료되면 자리가 확정됩니다.",
    ],
  },
  {
    id: "school",
    ...
    category: "offline",
    categoryLabel: "오프라인 · 직접 배우기",
    short: "직장인 체력 향상 3단계 프로세스. 주 2회 3시간으로 일상 체력을 되살리는 정규 과정.",
    via: "온라인 신청",
    ...
    detail: [
      ...
      "수강료는 주 2회 31만원 / 주 3회 39만원 / 주 4회 45만원입니다. 신규 수강생은 기초를 다지는 입학반(비기너 수업, 8만원)을 먼저 수강한 뒤 정규 수업에 합류합니다. 체험 수업은 없지만, 2~3주 경험 후에도 맞지 않으면 이유를 묻지 않고 24시간 내 100% 환불해 드립니다.",
    ],
  },
  {
    id: "goods",
